    ...
    private void DelayedStart()
    {
        switch (gameObject.tag)
        {
            case "scroll_1":
                ...
                TextBox.text = LikeADatabase._texts[0];
                Title.text = LikeADatabase._titles[0];
                break;
            case "scroll_2":
                //TextBox.text = _texts[1];
                //Title.text = "Second scroll";
                TextBox.text = LikeADatabase._texts[1];
                Title.text = LikeADatabase._titles[1];
                break;
            case "scroll_3":
                //TextBox.text = _texts[2];
                //Title.text = "Third scroll";
                TextBox.text = LikeADatabase._texts[2];
                Title.text = LikeADatabase._titles[2];
                break;
            default:
                break;
        }
